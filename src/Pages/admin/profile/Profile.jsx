...
const Profile = () => {
  ...
  return (
    <div className="min-h-screen overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50 to-slate-50 p-8">
      {/* Toast Notification */}
      {toast && (
                ...
                {!isEditing ? (
                  ...
                  <>
                    ...
                    <button
                      ...
                      className="w-full flex items-center justify-center gap-2 px-6 py-3 bg-slate-200 text-slate-700 rounded-xl font-semibold hover:bg-slate-300 transition-all duration-300"
                    >
                      <X size={20} />
                      Cancel
                    </button>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  {isEditing ? (
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-xl border-2 bg-transparent border-slate-200 focus:border-blue-500 outline-none transition-colors"
                    />
                  ) : (
                ...
                <div>
                  ...
                  {isEditing ? (
                    ...
                    <div className="flex items-center gap-3 px-4 py-3 bg-slate-50 rounded-xl">
                      ...
                      <span className="text-slate-800 font-medium">{profileData.location}</span>
                    </div>
                  )}
                </div>
                ...
                <div>
                  ...
                  {isEditing ? (
                    ...
                    <div className="flex items-center gap-3 px-4 py-3 bg-slate-50 rounded-xl">
                      ...
                      <span className="text-slate-800 font-medium">{profileData.department}</span>
                    </div>
                  )}
                </div>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3 px-4 py-3 bg-slate-50 rounded-xl">
                    ...
                    <span className="text-slate-800 font-medium">{profileData.joinDate}</span>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-6">
                ...
                {isEditing ? (
                  <textarea
                    ...
                    className="w-full px-4 py-3 rounded-xl border-2 bg-transparent border-slate-200 focus:border-blue-500 outline-none transition-colors resize-none"
                    rows="4"
                  />
                ) : (
                  <p className="px-4 py-3 bg-slate-50 rounded-xl text-slate-700 leading-relaxed">
                    {profileData.bio}
                  </p>
                )}
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 bg-slate-50 rounded-xl hover:bg-slate-100 transition-colors">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-600">Receive email updates about activities</p>
                    </div>
                  </div>
                  <label className="relative inline-block w-12 h-6">
                    <input type="checkbox" defaultChecked className="sr-only peer" />
                    <div className="w-full h-full bg-slate-300 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-6 peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-0.5 after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                  </label>
                </div>
                ...
                <div className="flex items-center justify-between p-4 bg-slate-50 rounded-xl hover:bg-slate-100 transition-colors">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-semibold text-slate-800">Activity Tracking</p>
                      <p className="text-sm text-slate-600">Track your dashboard activities</p>
                    </div>
                  </div>
                  <label className="relative inline-block w-12 h-6">
                    <input type="checkbox" defaultChecked className="sr-only peer" />
